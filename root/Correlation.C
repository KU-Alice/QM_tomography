...
void Correlation(TString infilename  = "test_read.dat",TString  outfilename = "angulardist",Float_t MassCut = 0.)
{
  TString rootfile  = "./datafiles/"+outfilename +".root";
  TString inFileName = "./datafiles/"+infilename;
  myFile = new TFile(rootfile,"RECREATE");
  myTree = new TTree("MyTree", "MyTree");
  ofstream myoutfile (outfilename +".txt");
