...
//  ~FitterMichal();
  ...
  //void setcosthetabins(const char[]){

  //}

  //void setphibins(const char[]){
...
if(iPoint != -1){
  ...
  Float_t binsPhi2d[4] = {0.,(2./3.)*TMath::Pi(),(4./3.)*TMath::Pi(),2*TMath::Pi()};
  //Float_t binsCsT[4] = {-1,-0.5,0.5,1};
  Float_t binsCsT[5] = {-0.6,-0.3,0.0,0.3,0.6};
  Float_t binsCsT2d[5] = {-0.6,-0.3,0.0,0.3,0.6};
  ...
  if (type==0){
    ...
    if(!yieldPhiCsT ){
      ...
      yieldPhiCsT = new TH2F("yieldPhiCsT","yieldPhiCsT",3,binsPhi2d,4,binsCsT2d);
