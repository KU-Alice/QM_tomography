...
void traditional_fit_data_michal_1dfit_range(){
  FitterMichal ang;
  ReadFile cm;
  ReadFile cm_mc_rec;
  //ReadFile cm_mc_gen;
  ...
  // phi bins
  ang.FitJPsiMass(0, 1, 0.2, 0, 0.4*TMath::Pi(), -0.6, 0.6, 116, 2.2, 4.5,0);
  ang.FitJPsiMass(1, 1, 0.2, 0.4*TMath::Pi(), 0.8*TMath::Pi(), -0.6, 0.6, 116, 2.2, 4.5,0);
  ang.FitJPsiMass(2, 1, 0.2, 0.8*TMath::Pi(), 1.2*TMath::Pi(), -0.6, 0.6, 116, 2.2, 4.5,0);
  ang.FitJPsiMass(3, 1, 0.2, 1.2*TMath::Pi(),1.6*TMath::Pi(), -0.6, 0.6, 116, 2.2, 4.5,0);
  ang.FitJPsiMass(4, 1, 0.2, 1.6*TMath::Pi(),2*TMath::Pi(), -0.6, 0.6, 116, 2.2, 4.5,0);

  //costheta bins

  ang.FitJPsiMass(0, 1, 0.2, 0.0, 2*TMath::Pi(), -0.6, -0.3, 116, 2.2, 4.5,1);
  ang.FitJPsiMass(1, 1, 0.2, 0.0, 2*TMath::Pi(), -0.3, 0.0, 116, 2.2, 4.5,1);
  ang.FitJPsiMass(2, 1, 0.2, 0.0, 2*TMath::Pi(), 0.0, 0.3, 116, 2.2, 4.5,1);
  ang.FitJPsiMass(3, 1, 0.2, 0.0, 2*TMath::Pi(), 0.3, 0.6, 116, 2.2, 4.5,1);
